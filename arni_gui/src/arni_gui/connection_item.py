...
def __init__(self, seuid, type, can_execute_actions, parent=None):
    ...
    #add the content
    attributes = ["topic", "node_pub", "node_sub", "window_start", "window_stop", "dropped_msgs", "traffic",
                  "period_mean", "period_stddev", "period_max", "stamp_age_mean", "stamp_age_stddev", "stamp_age_max"]
